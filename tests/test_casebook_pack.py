"""Regression checks for the gosweep casebook."""
...
from casebook.harness import assert_expected, gosweep_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(gosweep_summary(), assert_expected())
