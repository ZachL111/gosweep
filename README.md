...
gosweep is a Go project for automation. It focuses on this technical goal: Plan concurrent cleanup operations with safety rails and deterministic logs.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 153, risk penalty 7, latency penalty 4, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
