...
`gosweep` is centered on automation work in Go. The technical target is: Plan concurrent cleanup operations with safety rails and deterministic logs.
...
The score is deterministic. The current threshold is 153. Risk has a penalty of 7, latency has a penalty of 4, and weight contributes a bonus of 5.
